...
class BarrelSystem:
    ...
    def explode_at(self, pos: pygame.Vector2, players: List[object], sound=None) -> None:
    ...
    def handle_bullet_hit(self, bullet_rect: pygame.Rect, players: List[object],sound=None) -> bool:
        """
        ...
        for b in self.barrels[:]:
            if bullet_rect.colliderect(b.rect):
                ...
                self.explode_at(pos, players,sound=sound)
                return True
        return False
